...
window.addEventListener('DOMContentLoaded', function () {
  ...
  Object(_modules_timer__WEBPACK_IMPORTED_MODULE_5__["default"])('#timer', '2022-05-12');
...
var changeModalState = function changeModalState(state) {
  ...
  document.querySelectorAll('.popup_calc_content input').forEach(function (item) {
...
var checkNumInputs = function checkNumInputs(selector) {
  ...
  numInputs.forEach(function (item) {
    item.addEventListener('input', function () {
      item.value = item.value.replace(/\D\W/, '');
    });
  });
};
